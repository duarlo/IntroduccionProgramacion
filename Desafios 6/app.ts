...
{
    let city: string | null = prompt("Escribe el nombre de alguna ciudad de brazil");
    if (city) {
...
const addFunction = () => {
    let num1: number | null = parseFloat(prompt("Ingrese el primer número") || "");
    let num2: number | null = parseFloat(prompt("Ingrese el segundo número") || "");
