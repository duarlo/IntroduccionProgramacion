...
function customGeeting(name: string){
    let boxMessage = document.createElement("p");
...
function captureData(type: string,placeholder: string){
...
const doubleOperation = (userNumber:number) =>  {
    let boxMessage = document.createElement("p");
...
const averageOperation = (num1:number, num2:number, num3:number) =>  {
    let boxMessage = document.createElement("p");
...
generteSpace();
generteSpace();
 function submitButton(actionMessage : string){
...
const maximizerNumbers = (num1 : number, num2 : number) => {
    let maxiNumber : number;
    if (num1 < num2)
        maxiNumber = num2;
    else
        maxiNumber = num1;
...
const squareOperation = (userNumber:number) =>  {
    let boxMessage = document.createElement("p");
