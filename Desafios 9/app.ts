...
const maximizeNumberList = (numbers: number[]):number =>{
    return Math.max(...numbers);
}

const minimizeNumberList = (numbers: number[]):number =>{
...
const totalSum = (numbers: number[]): number =>{
...
const findNumberInList = (numbers: number[], numberToFind: number): number =>{
...
const SumOnetoOne = (listnumbersa: number[],listnumbersb: number[]):number[] =>{
